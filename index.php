            ...
            <div class="carousel slide carousel-fade" id="karusel" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="box">
                        ...
                        <?php
                        $query = "SELECT * FROM projects ORDER BY project_id DESC LIMIT 3";
                        ...
                        while($row = mysqli_fetch_assoc($select_projects)){
                            ...
                            <div class="carousel-item">
                                <div class="c-1">
                                    <p class="text-center bg-white "><a style="color: black; text-decoration: none" href="project.php?pr_id=<?=$project_id?>"><?=substr($project_content, 0, 300)?></a></p>
